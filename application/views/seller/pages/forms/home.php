        ...
        <div class="container-fluid p-3">
            <div class="row pt-4">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="alert alert-danger alert-dismissible" style="background-color: #fbd0d4;">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <h6 style="color:black;"><i class="icon fa fa-info"></i> <?= $count_products_availability_status ?> Product(s) sold out!</h6>
                        <a href="<?= base_url('seller/product/?flag=sold') ?>" class="text-decoration-none small-box-footer" style="color:black;">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="alert alert-primary alert-dismissible" style="background-color: #fbd0d4;">
                        ...
                        <a href="<?= base_url('seller/product/?flag=low') ?>" class="text-decoration-none small-box-footer" style="color:black;">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- Raghu -->
                ...
                <div class="row col-12 d-flex">
                    ...
                    <div class="col-3">
                        <div class="small-box" style="background-color: #ef519d;">
                            <div class="inner">
                                <h3 style="color:white;"><?= $status_counts['processed'] ?></h3>
                                <p style="color:white;">Processed</p>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-3">
                        <div class="small-box" style="background-color: #ef519d;">
                            <div class="inner">
                                <h3 style="color:white;"><?= $status_counts['shipped'] ?></h3>
                                <p style="color:white;">Shipped</p>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-3">
                        <div class="small-box" style="background-color: #ef519d;">
                            <div class="inner">
                                <h3 style="color:white;"><?= $status_counts['delivered'] ?></h3>
