                    ...
                    <div class="card content-area p-4">
                        <div class="card-innr">
                                ...
                                <div class="row col-12 d-flex">
                                    <div class="col-md-3">
                                        <div class="small-box" style="background-color: #ef519d;">
                                            <div class="inner">
                                                <h3 style="color: white;"><?= $status_counts['awaiting'] ?></h3>
                                                <p style="color: white;">Awaiting</p>
                                            </div>
                                            <div class="icon">
                                    ...
                                    <div class="col-md-3">
                                        <div class="small-box" style="background-color: #ef519d;">
                                            <div class="inner">
                                                <h3 style="color: white;"><?= $status_counts['received'] ?></h3>
                                                <p style="color: white;">Received</p>
                                            </div>
                                            <div class="icon">
                            ...
                            <div class="row col-md-6">
                                ...
                                <div class="row mx-2 pull-right">
                                    <a href="#" class="btn btn-info btn-sm settle_referal_cashback_discount" title="If you found Settle Reffral Cashback Discount not crediting using cron job you can update Settle user's Reffral Cashback Discount from here!">Settle User Cashback Discount</a>
                                </div>
                                <div class="row mx-2 pull-right">
                                    <a href="#" class="btn btn-secondary btn-sm settle_referal_cashback_discount_for_referal" title="If you found Settle Reffral Cashback Discount not crediting using cron job you can update Settle Reffral Cashback Discount from here!">Settle Reffral Cashback Discount</a>
                                </div>
                            </div>
                            <hr>
