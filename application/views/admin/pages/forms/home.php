        ...
        <!-- Raghu Style Tag -->
            <div class="row">
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="align-self-center text-warning">
                                        <i class="ion-ios-cart-outline display-4" style="color: #8b285d;"></i>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="align-self-center text-primary">
                                        <i class="ion-ios-personadd-outline display-4" style="color: #8b285d;"></i>
                                    </div>
                                    <div class="media-body text-right">
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="align-self-center text-success">
                                        <i class="ion-ios-people-outline display-4" style="color: #8b285d;"></i>
                                    </div>
                                    <div class="media-body text-right">
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="align-self-center text-info">
                                        <i class="ion-ios-albums-outline display-4 display-4" style="color: #8b285d;"></i>
                                    </div>
                                    <div class="media-body text-right">
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box" style="background-color: #ef519d;">
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box" style="background-color: #ef519d;">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text" style="color:white;">Seller Earnings (<?= $currency ?>) </span>
                            <span class="info-box-number" style="color:white;"><?= number_format($seller_earnings,2) ?></span>
                        </div>
                    </div>
                </div>
                <!-- Raghu -->
                <div class="col-md-6 col-xs-12">
                    <div class="alert alert-primary alert-dismissible" style="background-color: #fbd0d4;">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <h6 style="color:black;"><i class="icon fa fa-info"></i> <?= $count_products_availability_status ?> Product(s) sold out!</h6>
                        <a href="<?= base_url('admin/product/?flag=sold') ?>" class="text-decoration-none small-box-footer" style="color:black;">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="alert alert-primary alert-dismissible" style="background-color: #fbd0d4;">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <h6 style="color:black;"><i class="icon fa fa-info"></i> <?= $count_products_low_status ?> Product(s) low in stock!<small> (Low stock limit <?= isset($settings['low_stock_limit']) ? $settings['low_stock_limit'] : '5' ?>)</small></h6>
                        <a href="<?= base_url('admin/product/?flag=low') ?>" class="text-decoration-none small-box-footer" style="color:black;">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- Raghu -->
                ...
                <div class="row col-12 d-flex">
                    ...
                    <div class="col-4">
                        <div class="small-box" style="background-color: #ef519d;">
                            <div class="inner">
                                <h3 style="color:white;"><?= (isset($count_approved_sellers) && !empty($count_approved_sellers)) ?  $count_approved_sellers : 0; ?></h3>
                                <p style="color:white;"><button class='btn btn-outline-success text-white border-0' data-toggle="modal" data-target="#approved_sellers">Approved sellers</button></p>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-4">
                        <div class="small-box" style="background-color: #ef519d;">
                            <div class="inner">
                                <h3 style="color:white;"><?= (isset($count_not_approved_sellers) && !empty($count_not_approved_sellers)) ?  $count_not_approved_sellers : 0; ?></h3>
                                <p style="color:white;"><button class='btn btn-outline-secondary text-white border-0' data-toggle="modal" data-target="#not_approved_sellers">Not Approved Sellers</button></p>
                    ...
                    <div class="col-4">
                        <div class="small-box" style="background-color: #ef519d;">
                            <div class="inner">
                                <h3 style="color:white;"><?= (isset($count_deactive_sellers) && !empty($count_deactive_sellers)) ?  $count_deactive_sellers : 0; ?></h3>
                                <p style="color:white;"><button class='btn btn-outline-danger text-white border-0' data-toggle="modal" data-target="#deactive_sellers">Deactiveted sellers</button></p>
                            </div>
                            <div class="icon">
                ...
                <div class="row col-12 d-flex">
                    ...
                    <div class="col-3">
                        <div class="small-box" style="background-color: #ef519d;">
                            <div class="inner">
                                <h3 style="color:white;"><?= $status_counts['cancelled'] ?></h3>
                                <p style="color:white;">Cancelled</p>
                            </div>
                            <div class="icon">
                                <i class="fa fa-xs fa-times-circle"></i>
                            </div>
                    ...
                    <div class="col-3">
                        <div class="small-box" style="background-color: #ef519d;">
                            <div class="inner">
                                <h3 style="color:white;"><?= $status_counts['returned'] ?></h3>
                                <p style="color:white;">Returned</p>
                            </div>
                            <div class="icon">
