                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                        <div class="row col mt-3">
                                            ...
                                            <div class="col-md-4 total_allowed_quantity <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                ...
                                                <input type="number" class="col-md-12 form-control" name="total_allowed_quantity" min="1" value="<?= (isset($product_details[0]['total_allowed_quantity'])) ? $product_details[0]['total_allowed_quantity'] : ''; ?>" placeholder='Total Allowed Quantity'>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        ?>
                                                            <div class="container-fluid row image-upload-section">
                                                                <?php
                                                                $other_images = json_decode($product_details[0]['other_images'],true);
                                                                if (json_last_error() === JSON_ERROR_NONE && is_array($other_images) && !empty($other_images)) {
                                    ...
                                    <div class="card-body pad">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="mb-3">
                                                <textarea name="extra_input_description" class="textarea addr_editor" placeholder="Place some text here"><?= (isset($product_details[0]['extra_description']) && !empty($product_details[0]['extra_description'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['extra_description'])) : ''; ?></textarea>
                                            </div>
