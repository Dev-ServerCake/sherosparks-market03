                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/sellers/add_seller'); ?>" method="POST" id="add_product_form">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Raghu - Removed Seller URL from the Form1 -->
                                <!-- <div class="form-group row">
                                    <label for="store_url" class="col-sm-2 col-form-label">URL </label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="store_url" pattern="\b((https?|http):\/\/)?(-\.)?([^\s\/?\.#-]+\.?)+([^\s]*)\b" placeholder="Store URL" name="store_url" value="<?= @$fetched_data[0]['store_url'] ?>">
                                    </div>
                                </div> -->
                                <div class="form-group row">
