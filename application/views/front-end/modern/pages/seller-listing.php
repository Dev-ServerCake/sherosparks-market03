...
<section class="container listing-page mb-15">
    <div class="product-listing card-solid py-4">
        <div class="row mx-0">
            ...
            <div class="">
                <h1><?= !empty($this->lang->line('sellers')) ? $this->lang->line('sellers') : 'Sellers' ?></h4>
            </div>
                                        ...
                                        <div class="align-items-center d-flex">
                                            ...
                                            <div class="col-md-9">
                                                <div class="product-content">
                                                    ...
                                                    <a href="<?= base_url('products?seller=' . $row['slug']) ?>" class="view-products  btn btn-sm rounded-pill mt-2" style="background-color:#8b285d;color:white;"><?= !empty($this->lang->line('view_products')) ? $this->lang->line('view_products') : 'View Products' ?></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-6 mt-5 " title="<?= $row['seller_name'] ?>">
                                    <div class="card text-center">
                                        ...
                                        <div class="product-content my-3">
                                            ...
                                            <a href="<?= base_url('products?seller=' . $row['slug']) ?>" class="view-products btn btn-xs rounded-pill" style="background-color:#8b285d;color:white;"><?= !empty($this->lang->line('view_products')) ? $this->lang->line('view_products') : 'View Products' ?></a>
