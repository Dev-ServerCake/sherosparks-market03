            ...
            <div class="col-12">
                <div class=' border-0'>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <button class="my-2 btn btn-sm copy-button" style="background-color:#8b285d;color:white;" onclick="copyText()"><?= !empty($this->lang->line('tap_to_copy')) ? $this->lang->line('tap_to_copy') : 'Tap to copy' ?></button>
