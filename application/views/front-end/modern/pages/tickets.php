    ...
    <div class="container mb-15">
        ...
        <div class="home_faq">
            <div class="align-items-center d-flex flex-wrap justify-content-between">
                ...
                <button type="submit" class="btn btn-sm viewmorebtn ticket_button" value="Save" style="background-color:#8b285d;color:white;"><?= !empty($this->lang->line('create_a_ticket')) ? $this->lang->line('create_a_ticket') : 'Create a ticket' ?></button>
            </div>
            <hr class="mt-5 mb-5">
            <div class="display_fields col-md-12 d-none">
                <form class="form-horizontal form-submit-event" id="stock_adjustment_form" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn mt-2 ask_question" value="Save" style="background-color:#8b285d;color:white;"><?= !empty($this->lang->line('send')) ? $this->lang->line('send') : 'Send' ?></button>
