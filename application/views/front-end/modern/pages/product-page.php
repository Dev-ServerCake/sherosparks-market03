                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <figure class="rounded">
                                            <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url('media/image?path=' . $product['product'][0]['relative_path'] . '&width=900&quality=80') ?>" alt="" class="lazy product_other_images" >
                                    ...
                                    ?>
                                                    <div class="swiper-slide 12345">
                                                        <figure class="rounded">
                                                            <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url('media/image?path=' . $image . '&width=900&quality=80') ?>" class="lazy product_other_images" alt="" >
                                    ...
                                    ?>
                                            <div class="swiper-slide">
                                                <figure class="rounded">
                                                    <img src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url('media/image?path=' . $other_image . '&width=900&quality=80') ?>" class="lazy product_other_images" alt="" id="img_01" >
                ...
                <div class="post-header mb-5">
                    ...
                    if (($product['product'][0]['variants'][0]['special_price'] < $product['product'][0]['variants'][0]['price']) && ($product['product'][0]['variants'][0]['special_price'] != 0)) { ?>
                        <p class="my-1 price text-muted">
                            <span id="price" style='font-size: 18px;color:#8b285d;font-weight: bold;'>
                        ...
                        ?>
                            <form class="mt-2" id="validate-zipcode-form" method="POST">
                                <div class="input-group">
                                    ...
                                    <!-- </div> -->
                                    <button type="submit" class="btn btn-sm ml-0" id="validate_zipcode" style="background-color: #8b285d;color:white;"><?= !empty($this->lang->line('check_availability')) ? $this->lang->line('check_availability') : 'Check Availability' ?></button>
                                </div>
                    ...
                    <div class="col-lg-10 d-flex flex-row pt-2 gap-1 product-page-div p-0">
                        ...
                        <?php if ($product['product'][0]['variants'][0]['cart_count'] != 0) { ?>
                            <a class="btn btn-icon btn-xs btn-icon-start rounded-pill"   style="background-color: #8b285d;color:white;" href="<?= base_url('cart') ?>"><i class='uil uil-arrow-right'></i> <?= !empty($this->lang->line('go_to_cart')) ? $this->lang->line('go_to_cart') : 'Go To Cart' ?></a>
                        <?php } else { ?>
                            <button type="button" name="add_cart" class="add_to_cart btn btn-xs rounded-pill " id="add_cart"
                                ...
                                data-product-variant-id="<?= $variant_id ?>" data-product-stock="<?= $product_stock ?>" style="background-color: #fbd0d4;color:black;">
                                <i class="uil uil-shopping-bag mr-2"></i> <?= !empty($this->lang->line('add_to_cart')) ? $this->lang->line('add_to_cart') : 'Add to Cart' ?>
                            </button>
                        <?php } ?>
                        <button type="button" name="buy_now" class="buy_now btn btn-xs rounded-pill" id="buy_now" style="background-color: #8b285d; color:white;" title="<?= !empty($this->lang->line('buy_now')) ? $this->lang->line('buy_now') : 'Buy Now' ?>" data-product-id="<?= $product['product'][0]['id'] ?>" data-product-title="<?= $product['product'][0]['name'] ?>" data-product-slug="<?= $product['product'][0]['slug'] ?>" data-product-image="<?= $product['product'][0]['image'] ?>" data-product-price="<?= ($variant['special_price'] > 0 && $variant['special_price'] != '0' && $variant['special_price'] != '') ? $variant['special_price'] : $variant['price']; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($product['product'][0]['short_description'])))); ?>" data-step="<?= (isset($product['product'][0]['minimum_order_quantity']) && !empty($product['product'][0]['quantity_step_size'])) ? $product['product'][0]['quantity_step_size'] : 1 ?>" data-min="<?= (isset($product['product'][0]['minimum_order_quantity']) && !empty($product['product'][0]['minimum_order_quantity'])) ? $product['product'][0]['minimum_order_quantity'] : 1 ?>" data-max="<?= (isset($product['product'][0]['total_allowed_quantity']) && !empty($product['product'][0]['total_allowed_quantity'])) ? $product['product'][0]['total_allowed_quantity'] : 1 ?>" data-product-variant-id="<?= $variant_id ?>">
                            <i class="mr-2 uil uil-bolt-alt"></i><?= !empty($this->lang->line('buy_now')) ? $this->lang->line('buy_now') : 'Buy Now' ?>
                        </button>
                        <button type="button" name="compare" class="btn btn-icon btn-sm rounded-pill w-15 p-0 compare" id="compare" title="<?= !empty($this->lang->line('compare')) ? $this->lang->line('compare') : 'Compare' ?>" style="border-color: #8b285d;color:#8b285d;" data-product-id="<?= $product['product'][0]['id'] ?>" data-product-variant-id="<?= $variant_id ?>">
                            <i class="uil uil-exchange-alt fs-20"></i>
                        </button>

                        <button class="item-like text-decoration-none btn-sm rounded-pill w-15 p-0 fs-19 fav_button_dif add-to-fav-btn <?= ($product['product'][0]['is_favorite'] == 1) ? 'fa fa-heart text-danger' : 'fa fa-heart-o' ?>" href="#" title="<?= !empty($this->lang->line('add_to_wishlist')) ? $this->lang->line('add_to_wishlist') : 'Add To wishlist' ?>" style="border-color: #8b285d;color:#8b285d;" onmouseover="this.style.backgroundColor='white';" data-product-id="<?= $product['product'][0]['id'] ?>">
                            <i class=""></i>
                        </button>
...
<section class="wrapper bg-gray">
    <div class="container pb-10 overflow-hidden">
        ...
        <div class="col-12 pb-4 mt-2 mb-2 shop">
            ...
            <!-- <div class="swiper-container grid-view mySwiper" data-margin="30" data-dots="true" data-items-xl="4" data-items-md="2" data-items-xs="2"> -->
                            ...
                            <figure class="rounded ">
                                <div>
                                    <a href="<?= base_url('products/details/' . $product_row['slug']) ?>">
                                        <img class="lazy fig_image image-fit" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url('media/image?path=' . $product_row['relative_path'] . '&width=640&quality=80') ?>" alt="<?= $product_row['name'] ?>">
                                    </a>
                                </div>

                                <a class="item-like text-decoration-none add-to-fav-btn 
                                                            <?= ($product_row['is_favorite'] == 1) ? 'fa fa-heart text-danger' : 'fa fa-heart-o' ?>  
                                                            " href="#" data-bs-toggle="white-tooltip" title="<?= !empty($this->lang->line('add_to_wishlist')) ? $this->lang->line('add_to_wishlist') : 'Add To wishlist' ?>" data-product-id="<?= $product_row['id'] ?>">
                                    <i class=""></i>
                                </a>
                                ...
                                <div class="card-body my-4 style_4">
                                    ...
                                    <div class="product-content mt-2">
                                        ...
                                        ?>
                                        <a href="#" class="add_to_cart  btn btn-xs rounded-pill" data-product-id="<?= $product_row['id'] ?>" data-product-stock="<?= $product_stock ?>" data-product-variant-id="<?= $variant_id ?>" data-product-title="<?= $product_row['name'] ?>" data-product-slug="<?= $product_row['slug'] ?>" data-product-image="<?= $product_row['image']; ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($product_row['short_description'])))); ?>" data-izimodal-open="<?= $modal ?>" style="background-color:#8b285d;color:white;">
