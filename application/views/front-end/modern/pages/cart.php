        ...
        <div class="col-xl-8 mt-5 bg-white">
            <div class="cart-table-wrapper">
                <div class="text-right">
                    <button name="clear_cart" id="clear_cart" class="btn btn-sm rounded-pill mt-3 mb-4" style="background-color:#8b285d;color:white;"><?= !empty($this->lang->line('clear_cart')) ? $this->lang->line('clear_cart') : 'Clear Cart' ?></button>
                </div>
                                        ...
                                        <tr class="cart-product-desc-list">
                                            <td class="option text-start d-flex flex-row align-items-center ps-0" title="<?= $row['name']; ?>">
                                                ...
                                                <div class="w-100 ms-4">
                                                    ...
                                                    <button class="btn remove-product btn-outline-warning move-to-cart btn-xs" data-id="<?= $row['id']; ?>" data-qty="<?= $row['qty'] ?>"><?= !empty($this->lang->line('move_to_cart')) ? $this->lang->line('move_to_cart') : 'Move to cart' ?></button>
                                                </div>
                                            </td>
                                            <td>
                                                <p class="price"><span class="amount"><?= $settings['currency'] . '' . number_format($price, 2) ?></span></p>
        ...
        <div class="col-lg-4 mt-10">
            ...
            <div class="checkout-method">
                <a href="<?= base_url('cart/checkout') ?>" id="checkout">
                    <button class="btn rounded-pill w-100 mt-4" <?= $disabled ?> style="background-color:#8b285d;color:white;">
