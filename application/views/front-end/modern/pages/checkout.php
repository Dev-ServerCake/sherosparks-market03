                    ...
                    <div class="bg-white mt-5">
                        ...
                        <div class="ship-details-wrapper address-details">
                            ...
                            if (($cart[0]['type'] == 'digital_product')) { ?>
                                <div class="mt-3">
                                    <input name="email" type="text" id="digital_product_email" class="form-control" placeholder="<?= !empty($this->lang->line('please_enter_your_email_id')) ? $this->lang->line('please_enter_your_email_id') : 'Please enter your email ID'; ?>">
                                </div>
                            <?php } ?>
                                        ...
                                        <?php if (isset($payment_methods['cod_method']) && $payment_methods['cod_method'] == 1) { ?>
                                            <tr>
                                                <label for="cod">
                                                    ...
                                                    <td>
                                                        <label for="cod">
                                                            <img loading="lazy" src="<?= THEME_ASSETS_URL . 'img/payments/cod.png' ?>" class="payment-gateway-images <?= isset($cart[0]['is_cod_allowed']) && $cart[0]['is_cod_allowed'] == 0 ? 'gray_slale_cod' : '' ?>" alt="COD">
                                                        </label>
                                                    </td>
                                                    <td>
                            ...
                            <div class="product-checkout-wrapper">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn rounded-end" style="background-color:#8b285d;color:white;" id="redeem_btn"><?= !empty($this->lang->line('redeem')) ? $this->lang->line('redeem') : 'Redeem' ?></button>
                                ...
                                <button class="block btn rounded-pill w-100 mt-4" id="place_order_btn" style="background-color:#8b285d;color:white;" type="submit" <?= ($is_disabled) ? "disabled" : ""; ?>><?= !empty($this->lang->line('place_order')) ? $this->lang->line('place_order') : 'Place Order' ?></button>
                            </div>
                        </div>
                    </div>
                </div>
