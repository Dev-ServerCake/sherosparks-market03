        ...
        <div>
            ...
            <div class="card p-7">
                ...
                <form class="form-submit-event" method="POST" action="<?= base_url('login/update_user') ?>">
                    ...
                    <button type="submit" class="btn btn-sm btn-5 submit_btn" style="background-color:#8b285d;color:white;"><?= !empty($this->lang->line('save')) ? $this->lang->line('save') : 'Save' ?></button>
