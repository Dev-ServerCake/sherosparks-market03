...
<!-- Raghu Comment - Product listing loop -->
                    <?php if (isset($products) && !empty($products['product'])) { ?>
                                        ...
                                        <div class="product-image item">
                                            <figure class="rounded">
                                                <a href="<?= base_url('products/details/' . $row['slug']) ?>">
                                                    <img class="pic-1 lazy fig_image w-100 image-fit" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url('media/image?path=' . $row['relative_path'] . '&width=320&quality=80') ?>">
                                                </a>
                                ...
                                <div class="row ">
                                    ...
                                    ?>
                                        <div class="project item col-6 col-xl-4 default-style my-2" title="<?= $row['name']; ?>">
                                            <figure class="rounded">
                                                <a href="<?= base_url('products/details/' . $row['slug']) ?>">
                                                    <img class="image-fit pic-1 lazy fig_image" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= base_url('media/image?path=' . $row['relative_path'] . '&width=600&quality=80') ?>">
                                                </a>
                                                <div class="desktop_quick_view">
                                                    <a class="item-like text-decoration-none add-to-fav-btn 
                                                            <?= ($row['is_favorite'] == 1) ? 'fa fa-heart text-danger' : 'fa fa-heart-o' ?>  
                                                ...
                                                <div class="desktop_quick_view">
                                                    <!-- Raghu -->
                                                    <a href="#" class="add_to_cart item-cart text-decoration-none" style="background-color: #8b285d!important;" data-product-id="<?= $row['id'] ?>" data-product-stock="<?= $product_stock ?>" data-product-variant-id="<?= $variant_id ?>" data-product-title="<?= $row['name'] ?>" data-product-image="<?= $row['image']; ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($row['short_description'])))); ?>" data-izimodal-open="<?= $modal ?>">
                                            ...
                                            <div class="my-2 post-header">
                                                ...
                                                <?php if (($row['variants'][0]['special_price'] < $row['variants'][0]['price']) && ($row['variants'][0]['special_price'] != 0)) { ?>
                                                    <p class="price" style="color:#8b285d;">
                                                        <span id="price">
                                                            <?php echo $settings['currency'] ?>
                                                            <?php
                                                            $price = $row['variants'][0]['special_price'];
                        ...
                        <div class=" order-md-1 filter-section sidebar-filter-sm pt-2 pb-2 filter-sidebar-view">
                            <?php if (isset($products['filters']) && !empty($products['filters'])) { ?>
                                <div class="align-content-center d-flex justify-content-between">
                                    ...
                                    <a href="#" class="text-decoration-none hover product_filter_btn" style="color:#8b285d;"><?= !empty($this->lang->line('filter')) ? $this->lang->line('filter') : 'Filter' ?></a>
                                </div>
                            ...
                            <div class="text-center d-flex gap-2">
                                <button class="btn btn-sm rounded-pill w-50 product_filter_btn" style="background-color:#8b285d;color:white;"><?= !empty($this->lang->line('filter')) ? $this->lang->line('filter') : 'Filter' ?></button>
