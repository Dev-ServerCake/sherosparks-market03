                        ...
                        <div class="card">
                            <div class="bg-transparent card-body px-0 py-5">
                                <div class="d-flex justify-content-center flex-column gap-2">
                                    <a href="#" class="btn btn-xs rounded-pill mx-1 mb-2 mb-md-0 mx-xl-15" style="background-color:#8b285d;color:white;" data-bs-toggle="modal" data-bs-target="#myModal"><?= !empty($this->lang->line('add_money')) ? $this->lang->line('add_money') : 'Add Money' ?></a>
                                    <a href="#" class="btn btn-danger btn-xs rounded-pill mx-1 mb-2 mb-md-0 mx-xl-15" data-bs-toggle="modal" data-bs-target="#withdraw"><?= !empty($this->lang->line('withdraw_money')) ? $this->lang->line('withdraw_money') : 'Withdraw money' ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card col-md-12">
                            <div class="card-body bg-transparent">
                                <div class="h4 d-flex justify-content-center mt-2">
                                    <a href="#" class="btn btn-danger btn-xs rounded-pill mx-1 mb-2 mb-md-0" data-bs-toggle="modal" data-bs-target="#withdraw"><?= !empty($this->lang->line('withdraw_money')) ? $this->lang->line('withdraw_money') : 'Withdraw money' ?></a>
                                </div>
                            </div>
                        </div>
                    </div> -->
                                    ...
                                    <form class="form-horizontal form-submit-event" method="POST" id="wallet_form" enctype="multipart/form-data">
                                        ...
                                        <div class="align-items-start d-flex flex-column pl-4">
                                            <div class="ship-title-detail">
                                                <h5><?= !empty($this->lang->line('select_payment_method')) ? $this->lang->line('select_payment_method') : 'Payment Method' ?></h5>
                                            </div>
                                        ...
                                        <div class="modal-footer p-0 p-5">
                                            <button type="submit" class="btn btn-sm btn-success rounded-pill" id="wallet_refill" value="Save"><?= !empty($this->lang->line('refill')) ? $this->lang->line('refill') : 'Refill' ?></button>
                                            <button type="button" class="btn btn-danger btn-sm rounded-pill" data-bs-dismiss="modal"><?= !empty($this->lang->line('close')) ? $this->lang->line('close') : 'Close' ?></button>
                                        </div>
                                    </form>
                                    <!-- </form> -->
                                </div>
                            ...
                            <div class="modal-content card">
                                ...
                                <div class="ship-details-wrapper mt-3 payment-methods">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-sm btn-success rounded-pill" id="withdraw_amount" value="Save"><?= !empty($this->lang->line('withdraw')) ? $this->lang->line('withdraw') : 'Withdraw' ?></button>
                                        <button type="button" class="btn btn-danger btn-sm rounded-pill" data-bs-dismiss="modal"><?= !empty($this->lang->line('close')) ? $this->lang->line('close') : 'Close' ?></button>
                                    </div>
                                    <!-- </form> -->
                                </div>
