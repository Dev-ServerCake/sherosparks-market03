                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide swiper-slide-category">
                        <a href="<?= base_url('home/categories/') ?>" class="text-decoration-none">
                            <img src="<?= base_url('media/image?path=assets/front_end/modern/img/new/dashboard.png&width=110&quality=80') ?>" class="" alt="<?= !empty($this->lang->line('see_all')) ? $this->lang->line('see_all') : 'See All'; ?>" />
                            <h6 class="fs-14 mb-0" style="color: #8b285d;"><?= !empty($this->lang->line('see_all')) ? $this->lang->line('see_all') : 'See All'; ?></h6>
                        </a>
                    </div>
                    <?php
            ...
            <div class="row align-items-center">
                <div class="my-4 featured-section-title">
                    <div class="d-md-flex justify-content-md-between">
                        ...
                        <div>
                            <a href="<?= base_url('home/brands/') ?>" class="hover text-decoration-none" style="color: #8b285d;">
                ...
                <section class="wrapper mt-4">
                    <div class="my-4 featured-section-title">
                        <div class="align-items-center d-flex justify-content-between">
                            ...
                            <div>
                                <a href="<?= base_url('products/section/' . $row['id'] . '/' . $row['slug']) ?>" class="hover text-decoration-none" style="color: #8b285d;"><?= !empty($this->lang->line('view_more')) ? $this->lang->line('view_more') : 'View More' ?>
                                    <i class="uil uil-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                                        ...
                                        <div class="project item col-6 col-xl-3 default-style mb-3">
                                                ...
                                                <div class="desktop_quick_view">
                                                    <a class="item-like text-decoration-none add-to-fav-btn 
                                                        <?= ($product_row['is_favorite'] == 1) ? 'fa fa-heart text-danger' : 'fa fa-heart-o' ?>  
                                                                " href="#" data-bs-toggle="white-tooltip" title="<?= !empty($this->lang->line('add_to_favorite')) ? $this->lang->line('add_to_favorite') : 'Add to Favorite' ?>" data-product-id="<?= $product_row['id'] ?>">
                                                        <i class=""></i>
                                                    </a>
                                            ...
                                            <div class="post-header text-center mt-3">
                                                ...
                                                if (($product_row['variants'][0]['special_price'] < $product_row['variants'][0]['price']) && ($product_row['variants'][0]['special_price'] != 0)) { ?>
                                                    <p class="mb-0 price" style="color:#8b285d;">
                                                        <span id="price">
                                                        ...
                                                        <figure class="rounded ">
                                                            ...
                                                            <div class="card-body my-4">
                                                                ...
                                                                <div class="product-content  mt-2">
                                                                    ...
                                                                    $data_max = (isset($product_row['total_allowed_quantity']) && !empty($product_row['total_allowed_quantity'])) ? $product_row['total_allowed_quantity'] : 0;
                                                                    ?>
                                                                    <a href="#" class="add_to_cart  btn btn-xs rounded-pill" style="background-color:#8b285d;color:white;" data-product-id="<?= $product_row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-product-stock="<?= $product_stock ?>" data-product-title="<?= $product_row['name'] ?>" data-product-slug="<?= $product_row['slug'] ?>" data-product-image="<?= $product_row['image']; ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($product_row['short_description'])))); ?>" data-izimodal-open="<?= $modal ?>">
                                                                        <i class="uil uil-shopping-bag"></i>&nbsp;<?= !empty($this->lang->line('add_to_cart')) ? $this->lang->line('add_to_cart') : 'Add To Cart' ?></a>
                            ...
                            <figure class="">
                                ...
                                <div class="desktop_quick_view">
                                    <a class="item-like text-decoration-none add-to-fav-btn 
                                                ...
                                                " href="#" data-bs-toggle="white-tooltip" title="<?= !empty($this->lang->line('add_to_favorite')) ? $this->lang->line('add_to_favorite') : 'Add to Favorite' ?>" data-product-id="<?= $first_product['id'] ?>">
                                        <i class=""></i>
                                    </a>
                                ...
                                <div class="my-4 text-center">
                                    ...
                                    <div class="product-content mt-2">
                                        ...
                                        ?>
                                        <a href="#" class="add_to_cart  btn btn-xs rounded-pill" style="background-color:#8b285d;color:white;" data-product-id="<?= $first_product['id'] ?>" data-product-variant-id="<?= $variant_id ?>" ddata-product-stock="<?= $product_stock ?>" data-product-title="<?= $first_product['name'] ?>" data-product-slug="<?= $first_product['slug'] ?>" data-product-image="<?= $first_product['image']; ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($first_product['short_description'])))); ?>" data-izimodal-open="<?= $modal ?>">
                                            <i class="uil uil-shopping-bag"></i>&nbsp;<?= !empty($this->lang->line('add_to_cart')) ? $this->lang->line('add_to_cart') : 'Add To Cart' ?></a>
                                        ...
                                        <div class="col-md-4 mt-5 col-6">
                                            <div class="card item project">
                                                <figure class="">
                                                    ...
                                                    <div class="desktop_quick_view">
                                                        <a class="item-like text-decoration-none add-to-fav-btn <?= ($product_row['is_favorite'] == 1) ? 'fa fa-heart text-danger' : 'fa fa-heart-o' ?>" href="#" data-bs-toggle="white-tooltip" title="<?= !empty($this->lang->line('add_to_favorite')) ? $this->lang->line('add_to_favorite') : 'Add to Favorite' ?>" data-product-id="<?= $product_row['id'] ?>">
                                                            <i class=""></i>
                                                        </a>
                                                    ...
                                                    <div class="my-4 text-center style_3">
                                                        ...
                                                        <div class="product-content mt-2">
                                                            ...
                                                            $data_max = (isset($product_row['total_allowed_quantity']) && !empty($product_row['total_allowed_quantity'])) ? $product_row['total_allowed_quantity'] : 0;
                                                            ?>
                                                            <a href="#" class="add_to_cart  btn btn-xs rounded-pill" style="background-color:#8b285d;color:white;" data-product-id="<?= $product_row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-product-stock="<?= $product_stock ?>" data-product-title="<?= $product_row['name'] ?>" data-product-image="<?= $product_row['image']; ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= short_description_word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', strip_tags($product_row['short_description'])))); ?>" data-izimodal-open="<?= $modal ?>">
                                                                <i class="uil uil-shopping-bag"></i>&nbsp;<?= !empty($this->lang->line('add_to_cart')) ? $this->lang->line('add_to_cart') : 'Add To Cart' ?></a>
    ...
    <section class="wrapper bg-soft-grape">
        <div class="align-items-md-center d-flex flex-wrap justify-content-center gap-5 pb-15">
            <div>
                ...
                <!-- <img class="w-100 lazy" src="<? //= base_url('media/image?path=assets/front_end/modern/demo/avtars/4530199.png&width=500&quality=80') 
                                                    ?>" data-src="<? //= base_url('media/image?path=assets/front_end/modern/demo/avtars/4530199.png&width=500&quality=80') 
            ...
            <div class="col-md-7">
                ...
                <span><a href="<?= $web_settings['app_download_section_appstore_url'] ?>" target="_blank" class="btn btn-dark btn-icon btn-icon-start rounded-pill me-2"><i class="uil uil-apple"></i>
                        App Store</a></span>
                <span><a href="<?= $web_settings['app_download_section_playstore_url'] ?>" target="_blank" class="btn btn-icon btn-icon-start rounded-pill" style="background-color: #8b285d; color:white;"><i class="uil uil-google-play" ></i>
                        Google Play</a></span>
            </div>
            <!-- /.row -->
        </div>
