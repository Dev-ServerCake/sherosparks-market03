...
<footer class="text-inverse">
    <section class="angled pt-1 upper-end wrapper" style="background-color: #260b19;">
            ...
            <div class="row gy-6 gy-lg-0">
                <div class="col-md-4 col-lg-3">
                    <div class="widget">
                        ...
                        <?php } else { ?>
                            <p>Copyright &copy; <?= date('Y') ?> - <?= date('Y') + 1 ?>, All Right Reserved <a target="_blank" href="https://www.sherosparks.com/">SheroSparks</a></p>
                        <?php } ?>
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="widget">
                        <h4 class="widget-title text-white mb-3"><?= !empty($this->lang->line('useful_links')) ? $this->lang->line('useful_links') : 'Useful Links' ?></h4>
                        ...
                        <!-- Raghu url was - home/system-contact-us - above -->
                    </div>
                    <!-- /.widget -->
                </div>
                <!-- /column -->
        ...
        <div class="modal-content text-center">
            <div class="modal-body">
                <section id="login_div">
                    ...
                    <h2 class="mb-3 text-start"><?= !empty($this->lang->line('welcome_back')) ? $this->lang->line('welcome_back') : 'Welcome Back' ?></h2>
                    <p class="lead mb-6 text-start"><?= !empty($this->lang->line('fill_your_email_and_password_to_sign_in')) ? $this->lang->line('fill_your_email_and_password_to_sign_in') : 'Enter your Login details to sign in.' ?></p>
                    <form action="<?= base_url('home/login') ?>" class='form-submit-event' id="login_form" method="post">
                        ...
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" name="identity" placeholder="<?= !empty($this->lang->line('enter_mobile_number_or_email')) ? $this->lang->line('enter_mobile_number_or_email') : 'Enter Mobile Number / Email' ?>" id="loginEmail" value="<?= (ALLOW_MODIFICATION == 0) ? '1212121212' : '' ?>">
                            <label for="loginEmail"><?= !empty($this->lang->line('enter_mobile_number_or_email')) ? $this->lang->line('enter_mobile_number_or_email') : 'Enter Mobile Number / Email' ?></label>
                        </div>
                        <div class="form-floating password-field mb-4">
                            ...
                            <label for="loginPassword"><?= !empty($this->lang->line('password')) ? $this->lang->line('password') : 'Password' ?></label>
                        </div>
                        <!-- Raghu - Style -->
                        <footer>
                            ...
                            <button type="submit" class="submit_btn btn btn-sm rounded-pill" style="background-color: #8B285D;color:white;"><?= !empty($this->lang->line('login')) ? $this->lang->line('login') : 'Login' ?></button>
                        </footer>
                        <br>
                        ...
                        <?php if ((!empty($settings['google_login']) && $settings['google_login'] == 1) || (!empty($settings['facebook_login']) && $settings['facebook_login'] == 1)) { ?>
                            ...
                            <div class="row">
                                <div class="social-login col-md-12 text-center mt-3">
                                    ...
                                    <?php } ?>
                                    <?php if (!empty($settings['facebook_login']) && ($settings['facebook_login'] == 1 || $settings['facebook_login'] == '1')) { ?>
                ...
                <section class="hide pt-0" id="forgot_password_div">
                    ...
                    <form id="send_forgot_password_otp_form" method="POST" action="#">
                        <div class="input-group mb-5">
                            ...
                            <input type="text" class="form-control" name="mobile_number" id="forgot_password_number" placeholder="<?= !empty($this->lang->line('mobile_number')) ? $this->lang->line('mobile_number') : 'Mobile Number' ?>" value="">
                        </div>
                        ...
                        <footer>
                            <button type="button" data-bs-dismiss="modal" aria-label="Close" class="btn btn-soft-dark btn-sm rounded-pill"><?= !empty($this->lang->line('cancel')) ? $this->lang->line('cancel') : 'Cancel' ?></button>
                            <button type="submit" id="forgot_password_send_otp_btn" style="background-color: #8B285D;color:white;" class="submit_btn btn  btn-sm rounded-pill forgot-send-otp-btn"><?= !empty($this->lang->line('send_otp')) ? $this->lang->line('send_otp') : 'Send OTP' ?></button>
                        </footer>
                        <br>
                        <div class="d-flex justify-content-center">
                    ...
                    <form id="verify_forgot_password_otp_form" class="d-none" method="post" action="#">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" class="form-control" name="new_password" id="passwordInput" placeholder="<?= !empty($this->lang->line('new_password')) ? $this->lang->line('new_password') : 'New Password' ?>" value="" required>
                        ...
                        <footer>
                            ...
                            <button type="submit" class="btn btn-sm rounded-pill submit_btn" id="reset_password_submit_btn" style="background-color:#8b285d;color:white;"><?= !empty($this->lang->line('submit')) ? $this->lang->line('submit') : 'Submit' ?></button>
                        </footer>
                        <br>
                        <div class="d-flex justify-content-center">
...
<div class="modal fade" id="modal-signup" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content text-center">
            <div class="modal-body">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <h2 class="mb-3 text-start"><?= !empty($this->lang->line('Sign_up_here')) ? $this->lang->line('Sign_up_here') : 'Sign up Here' ?></h2>
                <p class="lead mb-6 text-start"><?= !empty($this->lang->line('registration_takes_less_than_a_minute')) ? $this->lang->line('registration_takes_less_than_a_minute') : 'Registration takes less than a minute.' ?></p>
                <section id="register_div">
                    <form id='send-otp-form' class='send-otp-form' action='#'>
                        <div class="row sign-up-verify-number">
                            <div class="col-12 d-flex justify-content-center pb-4">
                                <input type="text" class='form-input form-control' placeholder="<?= !empty($this->lang->line('enter_mobile_number')) ? $this->lang->line('enter_mobile_number') : 'Enter Mobile Number' ?>" id="phone-number" required>
                            </div>
                            <div class="col-12 d-flex justify-content-center pb-4">
                        ...
                        <footer>
                            <button type="button" data-bs-dismiss="modal" aria-label="Close" class="btn btn-soft-dark btn-sm rounded-pill"><?= !empty($this->lang->line('cancel')) ? $this->lang->line('cancel') : 'Cancel' ?></button>
                            <button id='send-otp-button' class="btn btn-sm rounded-pill" style="background-color: #8B285D;color:white;"><?= !empty($this->lang->line('send_otp')) ? $this->lang->line('send_otp') : 'Send OTP' ?></button>
                        </footer>
                        <p class="mb-0 mt-6"><?= !empty($this->lang->line('already_have_an_account')) ? $this->lang->line('already_have_an_account') : 'Already have an account?' ?>
                            <a class="text-decoration-none text-blue fs-15 hover" href="#" data-bs-target="#modal-signin" data-bs-toggle="modal" data-bs-dismiss="modal" class="hover"><?= !empty($this->lang->line('sign_in')) ? $this->lang->line('sign_in') : 'Sign In' ?></a>
                        </p>
                    ...
                    <form id='verify-otp-form' class='verify-otp-form d-none' action='<?= base_url('auth/register-user') ?>' method="POST">
                        <div class="row sign-up-verify-number">
                            ...
                            <div class="col-12 d-flex justify-content-center pb-4 form-floating">
                                <input type="text" class='form-input form-control' placeholder="<?= !empty($this->lang->line('otp')) ? $this->lang->line('otp') : 'OTP' ?>" id="otp" name="otp" autocomplete="off">
                                <label for="otp"><?= !empty($this->lang->line('otp')) ? $this->lang->line('otp') : 'OTP' ?></label>
                            </div>
                            <div class="col-12 d-flex justify-content-center pb-4 form-floating">
                                <input type="text" class='form-input form-control' placeholder="<?= !empty($this->lang->line('username')) ? $this->lang->line('username') : 'Username' ?>" id="name" name="name">
                                <label for="name"><?= !empty($this->lang->line('username')) ? $this->lang->line('username') : 'Username' ?></label>
                            </div>
                            <div class="col-12 d-flex justify-content-center pb-4 form-floating">
                                <input type="email" class='form-input form-control' placeholder="<?= !empty($this->lang->line('email')) ? $this->lang->line('email') : 'Email' ?>" id="email" name="email">
                                <label for="email"><?= !empty($this->lang->line('email')) ? $this->lang->line('email') : 'Email' ?></label>
                            </div>
                            <div class="col-12 d-flex justify-content-center pb-4 form-floating password-field">
                                <input type="password" class='form-input form-control' placeholder="<?= !empty($this->lang->line('password')) ? $this->lang->line('password') : 'Password' ?>" id="password" name="password">
                                <span class="password-toggle d-flex"><i class="uil uil-eye mb-4 mr-2"></i></span>
                                <label for="password"><?= !empty($this->lang->line('password')) ? $this->lang->line('password') : 'Password' ?></label>
                            </div>
                            <?php
                            ...
                            <div class="col-12 d-flex justify-content-center pb-4 form-floating ">
                                ...
                                <label for="friends_code"><?= !empty($this->lang->line('friends_code')) ? $this->lang->line('friends_code') : 'Friends code' ?></label>
                            </div>
                            <div class="col-12 d-flex justify-content-center pb-4">
                        ...
                        <footer>
                            ...
                            <button type="submit" id='register_submit_btn' class="btn btn-sm rounded-pill" style="background-color:#8b285d;color:white;"><?= !empty($this->lang->line('submit')) ? $this->lang->line('submit') : 'Submit' ?></button>
                        </footer>
                    </form>
                    <form id='sign-up-form' class='sign-up-form collapse' action='#'>
                        <input type="text" placeholder="<?= !empty($this->lang->line('username')) ? $this->lang->line('username') : 'Username' ?>" name='username' class='form-input form-control' required>
                        <input type="text" placeholder="email" name='<?= !empty($this->lang->line('email')) ? $this->lang->line('email') : 'Email' ?>' class='form-input form-control' required>
                        <input type="password" placeholder="<?= !empty($this->lang->line('password')) ? $this->lang->line('password') : 'Password' ?>" name='password' class='form-input form-control' required>
    ...
    <div class="row p-4">
        ...
        <div class="col-12 col-sm-6 product-page-details">
            ...
            <div class="d-flex mb-3 mt-2 text-center text-md-left gap-2 overflow-auto">
                ...
                <button class="m-0 add_to_cart mt-1 btn btn-xs rounded-pill w-100" style="background-color:#8b285d;color:white;" id="modal-add-to-cart-button">&nbsp;<i class="uil uil-shopping-bag fs-16"></i> <?= !empty($this->lang->line('add_to_cart')) ? $this->lang->line('add_to_cart') : 'Add To Cart' ?></button>

                <button class="m-0 buy_now mt-1 btn btn-xs rounded-pill w-100 <?= ($this->ion_auth->logged_in()) ? '' : 'disabled' ?>" style="background-color:#8b285d;color:white;" id="modal-buy-now-button"> &nbsp;<i class="uil uil-bolt fs-16"></i> <?= !empty($this->lang->line('buy_now')) ? $this->lang->line('buy_now') : 'Buy Now' ?></button>

                <!-- </div>
                <div> -->
                <button type="button" name="compare" class="btn btn-xs rounded-pill h-9 m-0 mt-1 compare" style="background-color:#8b285d;color:white;" id="compare"><i class="uil uil-exchange-alt fs-20"></i></button>
                <!-- </div>
                <div> -->
                <button class="btn btn-xs rounded-pill h-9 m-0 add-fav mt-1" style="background-color:#8b285d;color:white;" id="add_to_favorite_btn"><i class="fa fa-heart fs-20"></i></button>
                <!-- </div> -->
            </div>
