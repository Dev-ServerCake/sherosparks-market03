...
function send_sms($phone, $msg, $country_code = "+91")
{
    ...
    // print_r($data);
    // print_r($msg);
    // print_r(curl_sms($data["base_url"], $data["sms_gateway_method"], json_decode($msg), $data["header"]));
    return curl_sms($data["base_url"], $data["sms_gateway_method"], json_decode($msg), $data["header"]);
}
