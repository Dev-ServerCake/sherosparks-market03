...
$config['base_url'] = 'https://sherosparks.staunchpreview.com/';
...
$config['csrf_exclude_uris'] = array(
    'admin/product/process_bulk_upload', 'login/logout', 'home/login','cart/place-order','my-account/[a-z_-]+','my-account/update-order-item-status','auth/[a-z_-]+', 'home/[a-z_-]+', 'my-account/update_web_fcm', 'admin/custom_sms/view_sms_by_id', 'admin/Sms_gateway_settings/update_notification_module', 'admin/product/get_subcategory', 'admin/themes/switch',
    ...
    'app/v1/Chat_Api/[a-z_-]+', 'seller/app/v1/Chat_Api/[a-z_-]+', 'admin/webhook/[a-z_-]+', 'admin/media/upload', 'admin/webhook/phonepe_webhook', 'admin/chat/[a-z_-]+', 'seller/chat/[a-z_-]+', 'admin/orders/[a-z_-]+', 'seller/orders/[a-z_-]+','cart/manage'
);
